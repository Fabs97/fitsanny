...
# Make sure to replace 'com.fabs.fitsanny' with your actual app package name.
# The database file will be saved in the 'assets' directory of your Flutter project.
download-db:
	adb exec-out run-as com.fabs.fitsanny cat databases/fitsanny.db > assets/fitsanny.db
